...
function change_qty_add_to_cart_plus() {
  ...
  // Define the parameters for the request
   ...
   fetch(url, {
      ...
      headers: {
         ...
         'X-Requested-With': 'XMLHttpRequest' // Optional: identify the request as AJAX
      },
      body: body // Include the parameters in the request body
   })
      .then(response => {
         if (!response.ok) {
